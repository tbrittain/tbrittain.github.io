...
One downside to this second iteration of the project was that some artists didn't share any common genres with any other artists connected to the main "tree." Therefore, they weren't taken into account while they would have appeared on the original graph. 
Some genres (ahem... [filthstep](http://everynoise.com/engenremap-filthstep.html), [escape room](http://everynoise.com/engenremap-escaperoom.html) and [vapor twitch](http://everynoise.com/engenremap-vaportwitch.html) to name a few) I wasn't familiar with, so I discovered [Every Noise at Once](http://everynoise.com/engenremap.html), which is a pretty excellent, comprehensive catalog of every genre Spotify lists and helped to elucidate some of these strange genres for me.